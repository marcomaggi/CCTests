...
#define CCTESTS_UINT64_MAX_VAL		18446744073709551615uLL
#define CCTESTS_UINT64_MIN_VAL		0uLL

#define CCTESTS_INT32_MAX_VAL		+2147483647
#define CCTESTS_INT32_MIN_VAL		-2147483648
#define CCTESTS_INT64_MAX_VAL		+9223372036854775807LL
#define CCTESTS_INT64_MIN_VAL		-9223372036854775808LL
...
#else
uintptr_t const	CCTESTS_UINTPTR_MAX	= CCTESTS_INT64_MAX_VAL;
uintptr_t const	CCTESTS_UINTPTR_MIN	= CCTESTS_INT64_MIN_VAL;
#endif
