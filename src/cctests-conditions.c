...
DECLARE_CONDITION_ASSERTION_EXPECTED(size_t,	size_t,		PRIu32)
#else
DECLARE_CONDITION_ASSERTION_EXPECTED(size_t,	size_t,		PRIu64)
#endif

#if (4 == CCTESTS_SIZEOF_SSIZE_T)
DECLARE_CONDITION_ASSERTION_EXPECTED(ssize_t,	ssize_t,	PRId32)
#else
DECLARE_CONDITION_ASSERTION_EXPECTED(ssize_t,	ssize_t,	PRId64)
#endif
