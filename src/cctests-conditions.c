...
DECLARE_CONDITION_ASSERTION_EXPECTED(char_signed,	signed char,	"c")
DECLARE_CONDITION_ASSERTION_EXPECTED(char_unsigned,	unsigned char,	"c")

DECLARE_CONDITION_ASSERTION_EXPECTED(int_signed,	signed int,	"d")
DECLARE_CONDITION_ASSERTION_EXPECTED(int_unsigned,	unsigned int,	"u")

DECLARE_CONDITION_ASSERTION_EXPECTED(long_signed,	signed long,	"ld")
DECLARE_CONDITION_ASSERTION_EXPECTED(long_unsigned,	unsigned long,	"lu")
