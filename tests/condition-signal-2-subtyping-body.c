...
static my_descriptor_signal_2_subtype_t my_descriptor_signal_2_subtype_stru = {
...
my_descriptor_signal_2_subtype_t const * const my_descriptor_signal_2_subtype_ptr = &my_descriptor_signal_2_subtype_stru;
 ...
 */
{
  ...
  if (cce_location(L)) {
    ...
    my_condition_signal_2_subtype_t * C = cce_sys_malloc(L, sizeof(my_condition_signal_2_subtype_t));
    cce_error_handler_malloc_init(L, C_H, C);

    cce_condition_init((cce_condition_t *) C, &(my_descriptor_signal_2_subtype_ptr->descriptor));
...
{
  my_descriptor_signal_2_subtype_stru.descriptor.parent = &(cctests_descriptor_signal_2_ptr->descriptor);
}
