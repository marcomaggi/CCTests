...
{
  D->parent = cce_descriptor_pointer(my_descriptor_signal_2_subtype);
}
...
char const *
my_condition_static_message_signal_2_subtype (cce_condition_t const * C CCLIB_UNUSED)
{
 ...
 */
{
  ...
  if (cce_location(L)) {
    ...
    cce_condition_init((cce_condition_t *) C, cce_descriptor_pointer(my_descriptor_signal_2_subtype));
...
{
  return cce_condition_is(C, cce_descriptor_pointer(my_descriptor_signal_2_subtype));
}
...
{
  cce_descriptor_set_parent_to(cctests_descriptor_signal_2_t)(cce_descriptor_pointer(my_descriptor_signal_2_subtype));
}
