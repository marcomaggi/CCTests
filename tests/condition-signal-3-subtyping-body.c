/*
  Part of: CCTests
  Contents: body definitions of a subtype of "test signal-3"
  Date: Dec  6, 2017
...
static cce_condition_delete_fun_t		my_condition_delete_signal_3_subtype;
...
static my_descriptor_signal_3_subtype_t my_descriptor_signal_3_subtype_stru = {
  ...
  .descriptor.delete		= my_condition_delete_signal_3_subtype,
...
void
my_condition_final_signal_3_subtype (cce_condition_t * _C)
/* Finalisation  functions are  called automatically  when the  function
   ...
   the parent type. */
{
  my_condition_signal_3_subtype_t * C = (my_condition_signal_3_subtype_t *) _C;
  *(C->data) = 0;
  free(C->data);
...
void
my_condition_delete_signal_3_subtype (cce_condition_t * _C)
...
char const *
my_condition_static_message_signal_3_subtype (cce_condition_t const * C CCE_UNUSED)
{
  return "CCTests signal-3 subtype exceptional condition";
}
...
void
my_condition_init_signal_3_subtype (cce_destination_t L, my_condition_signal_3_subtype_t * C, int the_data)
 ...
 */
{
  cctests_condition_init_signal_3(&(C->signal_3));
...
my_condition_new_signal_3_subtype (cce_destination_t upper_L, int the_data)
/* This constructor function is the  public interface to the constructor
 * of condition objects of type "my_condition_signal_3_subtype_t".
 *
 * Here we:
 *
 ...
 */
{
  ...
  if (cce_location(L)) {
    ...
    my_condition_signal_3_subtype_t * C = cce_sys_malloc(L, sizeof(my_condition_signal_3_subtype_t));
