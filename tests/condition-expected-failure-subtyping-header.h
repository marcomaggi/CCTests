...
cctests_decl void cce_descriptor_set_parent_to(my_descriptor_expected_failure_subtype_t) (cce_descriptor_t * const D)
  __attribute__((__nonnull__(1)));

/* ------------------------------------------------------------------ */

cctests_decl void my_condition_init_expected_failure_subtype (cce_destination_t L, my_condition_expected_failure_subtype_t * C,
							      int the_data)
  __attribute__((__nonnull__(1,2)));

cctests_decl cce_condition_t const * my_condition_new_expected_failure_subtype (cce_destination_t L, int the_data)
  __attribute__((__nonnull__(1),__returns_nonnull__));

cctests_decl bool my_condition_is_expected_failure_subtype (cce_condition_t const * C)
