...
static my_descriptor_base_subtype_t my_descriptor_base_subtype = {
...
char const *
my_condition_static_message_base_subtype (cce_condition_t const * C CCLIB_UNUSED)
{
 ...
 */
{
  ...
  if (cce_location(L)) {
    ...
    cce_condition_init((cce_condition_t *) C, &(my_descriptor_base_subtype.descriptor));
...
{
  return cce_condition_is(C, &(my_descriptor_base_subtype.descriptor));
}
