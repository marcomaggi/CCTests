...
static my_descriptor_regex_compilation_error_subtype_t my_descriptor_regex_compilation_error_subtype = {
...
char const *
my_condition_static_message_regex_compilation_error_subtype (cce_condition_t const * C CCLIB_UNUSED)
{
