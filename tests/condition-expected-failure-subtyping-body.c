...
{
  D->parent = &my_descriptor_expected_failure_subtype.descriptor;
}
 ...
 */
{
  ...
  if (cce_location(L)) {
    ...
    cce_condition_init((cce_condition_t *) C, &(my_descriptor_expected_failure_subtype.descriptor));
...
{
  return cce_condition_is(C, &(my_descriptor_expected_failure_subtype.descriptor));
}
...
{
  cce_descriptor_set_parent_to(cctests_descriptor_expected_failure_t)(&my_descriptor_expected_failure_subtype.descriptor);
}
