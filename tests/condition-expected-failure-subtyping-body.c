...
static my_descriptor_expected_failure_subtype_t my_descriptor_expected_failure_subtype_stru = {
...
my_descriptor_expected_failure_subtype_t const * const my_descriptor_expected_failure_subtype_ptr = &my_descriptor_expected_failure_subtype_stru;
...
char const *
my_condition_static_message_expected_failure_subtype (cce_condition_t const * C CCE_UNUSED)
{
 ...
 */
{
  ...
  if (cce_location(L)) {
    ...
    my_condition_expected_failure_subtype_t * C = cce_sys_malloc(L, sizeof(my_condition_expected_failure_subtype_t));
...
{
  my_descriptor_expected_failure_subtype_stru.descriptor.parent = &(cctests_descriptor_expected_failure_ptr->descriptor);
}
