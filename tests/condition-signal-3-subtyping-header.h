...
cctests_decl my_descriptor_signal_3_subtype_t const * const	my_descriptor_signal_3_subtype_ptr;
...
{
  return cce_is_condition(C, &(my_descriptor_signal_3_subtype_ptr->descriptor));
}
