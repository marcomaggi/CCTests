...
cctests_decl void cce_descriptor_set_parent_to(my_descriptor_signal_subtype_t) (cce_descriptor_t * const D)
...
cctests_decl bool my_condition_is_signal_subtype (cce_condition_t const * C)
