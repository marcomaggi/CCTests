/*
  Part of: CCTests
  Contents: body definitions of a subtype of "regex error"
  Date: Dec  6, 2017
...
static cce_condition_delete_fun_t		my_condition_delete_regex_error_subtype;
...
static my_descriptor_regex_error_subtype_t my_descriptor_regex_error_subtype = {
  ...
  .descriptor.delete		= my_condition_delete_regex_error_subtype,
...
void
cce_descriptor_set_parent_to(my_descriptor_regex_error_subtype_t) (cce_descriptor_t * const D)
{
  D->parent = cce_descriptor_pointer(my_descriptor_regex_error_subtype);
}
...
void
my_condition_final_regex_error_subtype (cce_condition_t * _C)
/* Finalisation  functions are  called automatically  when the  function
   ...
   the parent type. */
{
  my_condition_regex_error_subtype_t * C = (my_condition_regex_error_subtype_t *) _C;
  *(C->data) = 0;
  free(C->data);
...
void
my_condition_delete_regex_error_subtype (cce_condition_t * _C)
...
char const *
my_condition_static_message_regex_error_subtype (cce_condition_t const * C CCLIB_UNUSED)
{
 ...
 */
{
  ...
  if (cce_location(L)) {
    ...
    cce_condition_init((cce_condition_t *) C, cce_descriptor_pointer(my_descriptor_regex_error_subtype));
...
{
  return cce_condition_is(C, cce_descriptor_pointer(my_descriptor_regex_error_subtype));
}
...
{
  cce_descriptor_set_parent_to(cctests_descriptor_regex_error_t)(cce_descriptor_pointer(my_descriptor_regex_error_subtype));
}
